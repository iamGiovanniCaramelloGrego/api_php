...
<head>
    <title>Controle de Alunos e de Cursos</title>
    <meta charset="utf-8">
                                            ...
                                            <div class="col-xl-12">
                                                <div class="card proj-progress-card">
                                                    <div class="card-block">
                                                        <div class="row">
                                                            ...
                                                            ?>
                                                                <h6>Alunos Cadastrados No Sistema</h6>
                                                                <h5 class="m-b-30 f-w-700"><?php echo $data['alunos']; ?>
                                                                    <span class="text-c-green m-l-10"><?php echo $perc_alunos;?>% de um total de 90</span>
                                                                </h5>
                                                                <div class="progress">
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-12 col-md-12">
                                                        <h2>Sobre</h2>
                                                        <p>Exercício para a demonstrar o consumo de uma API RestFull criada em PHP</p>
                                                    </div>
                                                </div>
                                            </div>
